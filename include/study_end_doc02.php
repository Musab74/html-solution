...
<HEAD>
<title><?=$SiteName?>_교육진행보고서_<?=$CompanyName?></title>
			...
			<div class="infoArea">
				...
				<div class="tableArea" style="text-align:center; margin-top:120px">
					<table style="margin:0 auto; border:0; font-weight:bold;">
						...
						<td width="96" style="border:0"><img src="/images/company_stamp4.png" align="absmiddle" width="70" height="70" /></td>
						<td style="border:0"></td>
						</tr>
					</table>
				</div>
				...
				<div class="tableArea" style="margin-top:90px;">
					<table style="font-weight:bold;">
						...
						<tr>
						<td style="font-size:15px;">부정훈련 신고 직통전화 / 담당자 전화번호 / 062-527-5425</td>
						</tr>
					</table>
				</div>
			</div>
