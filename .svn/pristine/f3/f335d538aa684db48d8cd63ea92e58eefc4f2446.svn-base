...
$kakao = Replace_Check($kakao);



$Sql = "INSERT INTO SiteInfomation
            (CompanyName, Ceo, CompanyNumber, SalesReportNumber, Phone, Fax, Email, 
                PersonalInformationManager, Address, Copyright, RegDate, KakaoURL) 
        VALUES('$CompanyName', '$Ceo', '$CompanyNumber', '$SalesReportNumber', '$Phone', '$Fax', '$Email', 
                '$PersonalInformationManager', '$Address', '$Copyright', NOW(), '$kakao')";
