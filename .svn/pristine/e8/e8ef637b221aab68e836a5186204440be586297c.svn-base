                ...
                <table width="100%" cellpadding="0" cellspacing="0" class="view_ty01">
                	<colgroup>
				  	...
				  	<tr>
                        <th>사업자 번호</th>
                        <td>
                        	<input name="CompanyCode" id="CompanyCode" type="text"  size="20" value="<?=$CompanyCode?>" maxlength="10">&nbsp;&nbsp;
    						<button type="button" onclick="CompanyCodeCheck();" class="btn round btn_LBlue line">중복 검색</button>&nbsp;&nbsp;&nbsp;&nbsp;<span id="CompanyCode_check_msg"></span>
    					</td>
                  	</tr>
				  	<?}else{?>
				  	<tr>
                  	...
                  	<tr>
                        <th>사업주 ID</th>
                        <td>
                        	<input name="CompanyID" id="CompanyID" type="text"  size="20" value="<?=$CompanyID?>">&nbsp;&nbsp;
    						<button type="button" onclick="CompanyIDCheck();" class="btn round btn_LBlue line">중복 검색</button>&nbsp;&nbsp;&nbsp;&nbsp;<span id="CompanyID_check_msg"></span>
    					</td>
                  	</tr>
				  	<?}else{?>
                  	<tr>
                  	...
                  	<tr>
                        ...
                        <td>
        					...
        					<input name="Fax2_01" id="Fax2_01" type="text"  size="6" value="<?=$Fax2_01?>" maxlength="3"> - <input name="Fax2_02" id="Fax2_02" type="text"  size="6" value="<?=$Fax2_02?>" maxlength="4"> - <input name="Fax2_03" id="Fax2_03" type="text"  size="6" value="<?=$Fax2_03?>" maxlength="4">
        				</td>
                  	</tr>
                  	<tr>
                        <th>업태/업종</th>
				  	...
				  	<tr>
                        <th>주소</th>
                        <td>
                        	<input name="Zipcode" id="Zipcode" type="text"  size="10" value="<?=$Zipcode?>">&nbsp;&nbsp;<button type="button" onclick="ZipcodeFind();" class="btn round btn_LBlue line"><i class="xi-maker"></i> 주소 찾기</button>
    						<p><input name="Address01" id="Address01" type="text"  size="60" value="<?=$Address01?>" placeholder="주소"> <input name="Address02" id="Address02" type="text"  size="60" value="<?=$Address02?>" placeholder="나머지 주소"></p>
    					</td>
                  	</tr>
				  	<tr>
                        <th>계좌정보</th>
    				...
    				<tr>
                        <th>사이버교육센터 주소</th>
                        <td>
                        	<input name="CyberURL" id="CyberURL" type="text"  size="60" value="<?=$CyberURL?>">&nbsp;&nbsp;&nbsp;&nbsp;
    						사이버교육센터 사용여부 : 
    				...
    				<tr>
                        <th>영업담당자명</th>
                        <td>
                        	<input name="SalesName" id="SalesName" type="text"  size="20" value="<?=$SalesName?>">&nbsp; 
    						<button type="button" onclick="SalesManagerSearch();" class="btn round btn_LBlue line"><i class="xi-search"></i> 검색</button>&nbsp;&nbsp;<span id="SalesManagerHtml"></span>
    					</td>
					</tr>
    				<tr>
                        <th>메모</th>
