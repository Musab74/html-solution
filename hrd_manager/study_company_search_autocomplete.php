...
$checkType   = Replace_Check($checkType);
...
?>
	<ul>
		<li><a href="Javascript:CompanySearchAutoCompleteApply('<?=$ROW['CompanyName']?>','<?=$ROW['CompanyCode']?>', '<?=$checkType?>')"><?=$i?>. <?=$CompanyNameResult?>&nbsp;&nbsp;<?=$ROW['CompanyCode']?></a></li>
	</ul>
<?
        $i++;
	}
