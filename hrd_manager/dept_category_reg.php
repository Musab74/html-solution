    					...
    					<table width="100%" cellpadding="0" cellspacing="0" class="view_ty01">
    						...
    						<tr>
    							...
    							<td valign="top">
        							...
        							<input type="checkbox" name="SubMenuGrant02" id="SubMenuGrant02_04" value="B4" <?if(in_array('B4',$SubMenuGrant_array)){?>checked<?}?>> <label for="SubMenuGrant02_04">리포트 부정훈련</label>
    							</td>
    							<td valign="top">
