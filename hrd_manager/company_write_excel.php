...
<script src="https://spi.maps.daum.net/imap/map_js_init/postcode.v2.js"></script>
	<div class="contentBody">
        ...
        <div class="conZone">
    	        ...
    	        <table width="100%" cellpadding="0" cellspacing="0" class="view_ty01">
                	...
                	<tr>
                  	...
                  	<tr>
                        <th>파일 등록</th>
                        <td>
                        	<input name="file" id="file" type="file"  size="60">&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<div class="btnAreaTl02 pt50"><span class="fs16b fc333B sub_title2">업로드한 엑셀파일 데이터 확인</span></div>
			<div class="tl pt15">
			...
			<table width="100%"  border="0" cellspacing="0" cellpadding="0" class="mt20">
				<tr>
					<td class="tl" width="150"><button type="button" id="BtnDelete" class="btn btn_DGray line" onclick="CheckedDelete()">선택항목 삭제</button></td>
					<td class="tc"><button type="button" id="BtnSubmit" class="btn btn_Blue" onclick="CompleteSubmitOk()">업로드 하기</button></td>
					<td class="tr" width="150"><button type="button" id="BtnList" class="btn btn_DGray line" onclick="location.href='<?=$PageName?>.php?pg=<?=$pg?>&sw=<?=urlencode($sw)?>&col=<?=$col?>'">목록</button></td>
				</tr>
			</table>
			<!-- //버튼 -->
		</div>
