...
$(document).ready(function() {	
    ...
    StudyProgressCheckWork('Start','N','<?=$ContentsURLSelect?>'); //시작 진도 - Progress(차시진도), Study(수강내역) 모두 업데이트(트리거 통해 이몬에 등록)
	...
	window.progressIntervalId = setInterval(function(){
		StudyProgressCheckWork('Middle','N','<?=$ContentsURLSelect?>'); //Progress(차시진도)만 업데이트
	},60000);
